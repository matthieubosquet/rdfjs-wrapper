import type { DataFactory, Quad_Subject, Quad_Predicate, DatasetCore, Term, Quad_Object } from "@rdfjs/types";

export class WrappingSet<T extends { term: Quad_Subject; } | string | number> implements Set<T> {
    ...
    public forEach(callbackfn: (item: T, index: T, set: Set<T>) => void, thisArg?: any): void {
